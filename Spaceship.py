...
def draw(canvas):
    ...
    canvas.draw_image(debris_image, center, size, (wtime + WIDTH / 2, HEIGHT / 2), (WIDTH, HEIGHT))
    canvas.draw_text('Lives',(20, 50), 50, 'White')
    canvas.draw_text(str(lives),(60, 100), 50, 'White')
    canvas.draw_text('Score',(650, 50), 50, 'White')
    canvas.draw_text(str(score),(700, 100), 50, 'White')
...
def rock_spawner():
    ...
    a_rock = Sprite(pos, vel, 0, 0, asteroid_image, asteroid_info)
