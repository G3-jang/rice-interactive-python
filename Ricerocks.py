...
def group_group_collide(group1, group2):
    ...
    for element in set(group1):
        track = group_collide(group2, element)
        if track > 0:
            track_collision += track
...
def draw(canvas):
    global time, started, lives, timer, rock_group
...
def rock_spawner():
    global rock_group, a_rock, score
...
frame.add_button('Stop_sound',stop_button)
